...
class WorkflowSerializer(serializers.ModelSerializer):
    ...
    sql_release_info = serializers.IntegerField(max_value=65535, default=0)
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "sql_index": {"required": False},
            "sql_release_info": {"required": False}
        }
...
class WorkflowContentSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        sql_release_info = workflow_data.get("sql_release_info", 0)
